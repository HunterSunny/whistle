...
// 插件名必须是whistle.your-plugin-name
...
function getPluginList(list) {
  ...
  if (Array.isArray(list)) {
    list.forEach(function(name) {
      // 名是否符合约定 whistle.your-plugin-name
...
exports.extend = function(newConf) {
      ...
      mode.forEach(function(m) {
        ...
        if (/^(pureProxy|debug|nohost|strict|multiEnv|multienv|encrypted|noGzip|disableUpdateTips|proxifier2?)$/.test(m)) {
          ...
          case 'clientip':
            ...
            config.cipKey = key; // clientip|clientid|tunneldata的值
            break;
          case 'clientid':
  ...
  return config;
  // 打印config信息为 package.json中数据加下面的数据
  // uid: '1629379210713-30520-9563',
  // rejectUnauthorized: false,
  // enableH2: true,
  // ASSESTS_PATH: '/home/work/projects/node/whistle-master/assets',
  // WHISTLE_REQ_FROM_HEADER: 'x-whistle-request-from',
  ...
  // INTERNAL_ID: '1629379210713/30520/37599',
  // INTERNAL_ID_HEADER: '_x-whistle-internal-id',
  // DATA_ID: 'x-whistle-data-id-1629379210713-30520-9563',
  // PROXY_ID_HEADER: 'x-whistle-proxy-id-1629379210713-30520-9563',
  // CLIENT_PORT_HEAD: 'x-whistle-client-port',
  // WEBUI_HEAD: 'x-forwarded-from-whistle-1629379210713-30520-9563',
  // RES_RULES_HEAD: 'x-whistle-res-rules-1629379210713-30520-9563',
  // CLIENT_INFO_HEAD: 'x-whistle-client-info-1629379210713-30520-9563',
  // WEBUI_PATH: '/.whistle-path.5b6af7b9884e1165/',
  // PREVIEW_PATH_RE: /\?\?\?WHISTLE_PREVIEW_CHARSET=([A-Z\d_-]+)\?\?\?$/,
  ...
  // TEMP_CLIENT_ID_HEADER: 'x-whistle-client-id-1629379210713-30520-9563',
  // TEMP_TUNNEL_DATA_HEADER: 'x-whistle-tunnel-data-1629379210713-30520-9563',
  // ALPN_PROTOCOL_HEADER: 'x-whistle-alpn-protocol',
  // PLUGIN_HOOKS: {
  //   HTTP: 'http-1629379210713-30520-9563',
  //   UI: 'ui-1629379210713-30520-9563',
  //   TUNNEL: 'tunnel-1629379210713-30520-9563',
  //   TUNNEL_RULES: 'tunnel-rules-1629379210713-30520-9563',
  //   REQ_STATS: 'req-stats-1629379210713-30520-9563',
  //   RES_STATS: 'res-stats-1629379210713-30520-9563',
  //   REQ_RULES: 'req-rules-1629379210713-30520-9563',
  //   RES_RULES: 'res-rules-1629379210713-30520-9563',
  //   REQ_READ: 'req-read-1629379210713-30520-9563',
  //   REQ_WRITE: 'req-write-1629379210713-30520-9563',
  //   RES_READ: 'res-read-1629379210713-30520-9563',
  //   RES_WRITE: 'res-write-1629379210713-30520-9563',
  //   WS_REQ_READ: 'ws-req-read-1629379210713-30520-9563',
  //   WS_REQ_WRITE: 'ws-req-write-1629379210713-30520-9563',
  //   WS_RES_READ: 'ws-res-read-1629379210713-30520-9563',
  //   WS_RES_WRITE: 'ws-res-write-1629379210713-30520-9563',
  //   TUNNEL_REQ_READ: 'tunnel-req-read-1629379210713-30520-9563',
  //   TUNNEL_REQ_WRITE: 'tunnel-req-write-1629379210713-30520-9563',
  //   TUNNEL_RES_READ: 'tunnel-res-read-1629379210713-30520-9563',
  //   TUNNEL_RES_WRITE: 'tunnel-res-write-1629379210713-30520-9563'
  // },
  // CONN_TIMEOUT: 30000,
  // getHomedir: [Function: getHomedir],
  // getHomePath: [Function: getHomePath],
  // baseDir: '/home/work/.WhistleAppData/.whistle',
  // SYSTEM_PLUGIN_PATH: '/home/work/.WhistleAppData/plugins',
  // CUSTOM_PLUGIN_PATH: '/home/work/.WhistleAppData/custom_plugins',
  // CUSTOM_CERTS_DIR: '/home/work/.WhistleAppData/custom_certs',
  // getWhistlePath: [Function: getWhistlePath],
  // getDataDir: [Function: getDataDir],
  // getHttpsAgent: [Function: getHttpsAgent],
  // getAuths: [Function: getAuths],
  // setAuth: [Function],
  // getPluginData: [Function],
  // setGuestAuth: [Function],
  // setUIHost: [Function],
  // setPluginUIHost: [Function],
  ...
  // allowPluginList: undefined,
  // blockPluginList: undefined,
  // encrypted: undefined,
  // storage: undefined,
  // noGlobalPlugins: undefined,
  // pluginsDataMap: undefined,
  // username: undefined,
  // password: undefined,
  // debugMode: true,
  // extra: undefined,
  ...
  // values: undefined,
  // dnsCache: undefined,
  // allowDisableShadowRules: undefined,
  // shadowRules: '',
  // host: '',
  // addon: undefined,
  // allowMultipleChoice: undefined,
  // disableAllRules: undefined,
  // disableAllPlugins: undefined,
  // replaceExistValue: undefined,
  // pluginPaths: undefined,
  // authKey: 'auto_16293792107170.978559',
  // middlewares: [],
  // uiHostList: [],
  // customLocalUIHost: undefined,
  // setLocalUIHost: [Function],
  // isLocalUIUrl: [Function: isLocalUIUrl],
  // isWebUIHost: [Function: isWebUIHost],
  // getPluginNameByHost: [Function],
  // httpAgent: false,
  // httpsAgent: false,
  // getSocksAgent: [Function],
  // baseDirHash: '9cc25d69c23032a03601c8f04cfa060353df20f3',
  // rulesDir: '/home/work/.WhistleAppData/.whistle/rules',
  // valuesDir: '/home/work/.WhistleAppData/.whistle/values',
  // propertiesDir: '/home/work/.WhistleAppData/.whistle/properties',
  // clientId: '1626752070271,0.623245133659408,0.9224775691224545,0.0039370593908525375,0.4701023797928072,0.49054348692672134',
  // LOCAL_FILES: '/home/work/.WhistleAppData/.whistle/local_files',
